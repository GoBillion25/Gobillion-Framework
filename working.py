...
def main():
    load_dotenv()
    st.set_page_config(page_title="Chat with Own Documents",
                       page_icon=":books:")
    ...
    st.header("Chat with Own Document :books:")
    ...
    with st.sidebar:
        ...
        if st.button("Process"):
            with st.spinner("Processing"):
                ...
                #raw_text = get_file_text_new(uploaded_files)
                # get the text chunks
